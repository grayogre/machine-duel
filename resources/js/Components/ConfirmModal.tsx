...
const ConfirmModal = memo((props: Props) => {
  ...
  return (
    ...
    <div className={'fixed flex flex-col items-center justify-center overflow-hidden bg-gray-500/50 transition-all z-40 ' + 
      ...
      <div className="w-80 h-40 flex flex-col justify-between bg-white">
      <div className="flex justify-start">
        ...
        <div className="flex justify-around">
          <button className="inline-flex items-center px-4 py-2 bg-blue-800 border border-transparent rounded-md font-semibold text-xs text-white hover:bg-blue-500 focus:bg-blue-500 active:bg-blue-900" onClick={() => close(true)}>
            はい
          </button>
          <button className="inline-flex items-center px-4 py-2 bg-blue-800 border border-transparent rounded-md font-semibold text-xs text-white hover:bg-blue-500 focus:bg-blue-500 active:bg-blue-900"
            onClick={() => close(false)}
          >
            いいえ
          </button>
